...
public class OrderController {
	...
	//주문정보 - 파라미터로 받아 저장, 주문상품정보는 cart테이블의 상품을 order-product 테이블로 이동
	...
	public String detailViewOrder(@PathVariable String ordNo, Model model) {
		// 주문 정보
	    OrderInfoDTO orderInfo = ordService.getOrderInfo(ordNo);
	    // 주문 상품 목록
	    ArrayList<OrderProductDTO> orderProductList = ordService.getOrderProductList(ordNo);
	    
	    model.addAttribute("orderInfo", orderInfo);
	    model.addAttribute("orderProductList", orderProductList);

	    return "product/detailViewOrder";
	}
