	...
	<div id="wrap">
		...
		<form method="post" action="<c:url value='/product/insertCart'/>">
			<table border="1" width="900">
				<tr>
					<td rowspan="9"><img
						src="<c:url value='/prd_images/${prd.prdImg}'/>" width="300"
						height="250"></td>
				</tr>
				<tr>
					<td>상품번호</td>
				...
				<tr>
					<td>가격</td>
					<td><span id="price" data-price=" ${prd.prdPrice}"> <fmt:formatNumber
								value="${prd.prdPrice}" pattern="#,###" />
					</span> 원</td>
				</tr>
				<tr>
					<td>제조회사</td>
				...
				<tr>
					<td>주문수량</td>
					<td><input type="button" id="minusBtn" value="-"> <input
						type="text" id="cartQty" name="cartQty" value="1" size="1"
						readonly> <input type="button" id="plusBtn" value="+">
					</td>
				</tr>
				<tr>
					<td>구매 예정 금액</td>
					<td><span id="amount"> <fmt:formatNumber
								value="${prd.prdPrice}" pattern="#,###" /></span> 원</td>
				</tr>
				<tr>
					<td colspan="2">
