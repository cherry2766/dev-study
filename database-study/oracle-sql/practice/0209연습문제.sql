...
ALTER TABLE department ADD DPTOFFICE VARCHAR2(10);

UPDATE department SET dptoffice = '경영관' WHERE dptname = '경영학과';
UPDATE department SET dptoffice = '공학관' WHERE dptname = '기계공학과';
UPDATE department SET dptoffice = '경영관' WHERE dptname = '컴퓨터공학과';

UPDATE department SET dpttel = '02-111-5555' WHERE dptname = '컴퓨터공학과';

UPDATE student SET stdaddress = '인천시' WHERE stdname = '성춘향';

UPDATE student SET stdyear = 4 WHERE dptno = '002';

DELETE FROM student WHERE stdaddress = '서울시';
...
-- 11.도서테이블에서 재고수량을 기준으로 내림차순 정렬하여 도서명, 저자, 재고 출력. 단, 재고수량이 동일한 경우 저자명으로 오름차순 2차 정렬 진행
